...
class Message(object):
    ...
    def apply_pad(self, pad):
        ...
        for i, v in enumerate(pad):
            return_text += self.shift_char(self.text[i],v)
        return return_text
...
class PlaintextMessage(Message):
    def __init__(self, input_text, pad=None):
        ...
        self.pad = pad.copy() if pad is not None else self.generate_pad()
    ...
    def generate_pad(self):
        ...
        '''
        return [random.randint(0,110) for char in self.text]
...
class EncryptedMessage(Message):
    ...
    def decrypt_message(self, pad):
        ...
        return_text = ""
        for i, v in enumerate(pad):
            return_text += self.shift_char(self.text[i],-1*v)
        return PlaintextMessage(return_text,pad)
